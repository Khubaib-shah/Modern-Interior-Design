...
const RelatedProperties = ({ related }: { related: Property[] }) => {
  return (
    <div className="relative">
      ...
      <div className="swiper-project-prev absolute top-1/2 left-2 z-20 cursor-pointer text-white text-2xl">
        ←
      </div>
      <div className="swiper-project-next absolute top-1/2 right-2 z-20 cursor-pointer text-white text-2xl">
        →
      </div>
    </div>
  );
